...
import { IncidentSaverity } from '@/interface/auditor/incident-reports/incidents'
...
export function FilterPopover({ onApply, currentFilters }: FilterPopoverProps) {
  ...
  const [selectedStatuses, setSelectedStatuses] = useState<IncidentSaverity[]>(currentFilters.statuses)
  const [isReady, setIsReady] = useState(false)

  const IncidentSaverityStatuses: IncidentSaverity[] = ["CRITICAL", "HIGH", "MEDIUM"]
  ...
  const handleStatusToggle = (status: IncidentSaverity) => {
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                {IncidentSaverityStatuses.map((status) => (
