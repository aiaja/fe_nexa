...
import { RiskLevel } from '@/interface/auditor/driver'
...
export function FilterPopover({ onApply, currentFilters }: FilterPopoverProps) {
  ...
  const [selectedStatuses, setSelectedStatuses] = useState<RiskLevel[]>(currentFilters.statuses)
  const [isReady, setIsReady] = useState(false)

  const RiskLeveles: RiskLevel[] = ["CRITICAL", "HIGH", "MEDIUM", "LOW"]
  ...
  const handleStatusToggle = (status: RiskLevel) => {
