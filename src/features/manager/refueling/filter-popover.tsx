...
import { RefuelingStatus } from '@/interface/manager/refueling-logbook'
...
export function FilterPopover({ onApply, currentFilters }: FilterPopoverProps) {
  ...
  const [selectedStatuses, setSelectedStatuses] = useState<RefuelingStatus[]>(currentFilters.statuses)
  const [isReady, setIsReady] = useState(false)

  const RefuelingStatuses: RefuelingStatus[] = ["Validated", "Pending", "Rejected"]
  ...
  const handleStatusToggle = (status: RefuelingStatus) => {
